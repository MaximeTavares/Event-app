...
import type { BaseMission, MissionDetailsApiResponse, UpdateMissionInput } from "../types/mission.type";
import type { MissionCreationFormValues } from "../validation/MissionCreation.schema";

export class MissionApi {
	static async createMission(eventId: number, mission: MissionCreationFormValues): Promise<BaseMission> {
